                ...
                Surface(Modifier.fillMaxSize()) {
                    ...
                    Column(Modifier
                        ...
                        Text(displayManager.name + ": " + currentRefreshRate.roundToInt()
                            .toString() + "Hz, " + displayManager.height.toString() + "x" + displayManager.width.toString(), fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 8.dp))
                        ...
                        var showRate by remember {
                            mutableStateOf(shell.run("service call SurfaceFlinger 1034 i32 2").stdout().contains("1"))
                        }
