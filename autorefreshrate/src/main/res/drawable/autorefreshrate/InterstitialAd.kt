...
fun loadInterstitial(context: Context) {
    if (!context.getSharedPreferences("my_preferences", Context.MODE_PRIVATE).getBoolean("isContributor", false)) {
...
fun showInterstitial(context: Context, onAdDismissed: () -> Unit = {}) {
    ...
    if (mInterstitialAd != null && activity != null && !context.getSharedPreferences("my_preferences", Context.MODE_PRIVATE)
