...
object DefaultCategoryData {
    ...
    val categories =
        listOf(
            ...
            // Uncategorized as a proper category with settings and launch tracking
            // Special: doesn't use include/exclude rules, only gets orphan apps
            CategoryData(
                name = "Uncategorized",
                defaultInclude = null, // No specific include - catches everything else
                defaultExclude = null,
                customInclude = null,
                customExclude = null,
                rows = 3,
                customBool = 0,
                customInt = 0,
                color = "#808080", // Gray color for uncategorized
            ),
        )
}
