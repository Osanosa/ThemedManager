    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        ...
        Column( modifier = Modifier) {
            ...
            Card(
                border = BorderStroke(
                    width = 1.dp,
                    color = colorResource(id = R.color.grey_outline)
                ), modifier = Modifier
                    .fillMaxWidth()
                    .wrapContentHeight()
                    .padding(8.dp)
...
private fun AccentsCard() {
    Card(border = BorderStroke(width = 1.dp, color = colorResource(id = R.color.grey_outline)),
        modifier = Modifier.fillMaxWidth().wrapContentHeight().padding(8.dp), elevation = (0.dp), shape = RoundedCornerShape(8.dp))
        {Column(modifier = Modifier) {
            Row(
                ...
                //Switch(checked = true, onCheckedChange = (null), modifier = Modifier.padding(8.dp))
            }
            ...
            LazyVerticalGrid(
                ...
                item {
                    Surface(
                        modifier = Modifier.background(Color(rgb(197, 17, 98))),
                        onClick = { Shell.SU.run("cmd overlay enable-exclusive --category themed.accents.MaterialPinkA700") }) {
                    }
                }
                item {
                    Surface(modifier = Modifier.background(Color(rgb(233, 30, 99))),
...
fun TopAppBar() {
    TopAppBar(
        ...
        actions = {
            ...
            val webIntent2 =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://www.themed.pro/"))
