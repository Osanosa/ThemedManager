...
fun buildOverlay(path: String = "") {
    CoroutineScope(Dispatchers.IO).launch {
        ...
        compileShell.run("""aapt2 link -o $PWD/unsigned.apk -I /system/framework/framework-res.apk --manifest $PWD/AndroidManifest.xml $PWD/*.flat --min-sdk-version 26 --target-sdk-version 29 --auto-add-overlay """)
