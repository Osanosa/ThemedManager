...
@Composable
fun ItemIcon(name: String, du: Boolean, mimetype: String? = null) {
    Box {
        if (!du) {
        ...
        val color =
            when {
                ...
                name.endsWith(".zip", true) ||
                    ...
                    name.endsWith(".xz", true) -> Color.hsl(30f, 1f, .5f)
                ...
                imageVector =
                    when {
                        ...
                        name.endsWith(".jpg", true) ||
                            ...
                            ImageVector.vectorResource(R.drawable.image_24px)
                        name.endsWith(".mp4", true) ||
                            name.endsWith(".mkv", true) ||
                            name.endsWith(".avi", true) ||
                            name.endsWith(".mov", true) ->
                            ImageVector.vectorResource(R.drawable.movie_24px)
                        name.endsWith(".mp3", true) ||
                            name.endsWith(".wav", true) ||
                            name.endsWith(".ogg", true) ||
                            name.endsWith(".flac", true) ->
                            ImageVector.vectorResource(R.drawable.music_note_24px)
                        name.endsWith(".pdf", true) ->
                            ImageVector.vectorResource(R.drawable.picture_as_pdf_24px)
                        name.endsWith(".zip", true) ||
                            name.endsWith(".rar", true) ||
                            name.endsWith(".7z", true) ||
                            name.endsWith(".tar", true) ||
                            ...
                            ImageVector.vectorResource(R.drawable.folder_zip_24px)
                        name.endsWith(".apk", true) ->
                            ImageVector.vectorResource(R.drawable.apk_document_24px)
